...
public class FileIO
{
    ...
    private static Dictionary<int, Sprite> map_sprite = new Dictionary<int, Sprite>();
    ...
    {
        Sprite sprite = map_sprite.GetValue(spriteIndex);
        if (sprite == null)
        {
            ...
            if (sprite == null)
            {
                sprite = Resources.Load<Sprite>(R.SpritePack.path[spriteIndex]);
            }
            map_sprite.Add(spriteIndex, sprite);
        }
    ...
    private static Sprite LoadSprite(string spriteName)
    {
        ...
        Sprite sprite = ab.LoadAsset<Sprite>(spriteNameArr[spriteNameArr.Length - 1]);
        return sprite;
    }
