...
#pragma warning disable 0162, 0219, 0414
    ...
    static void Pack(string source, bool isSpritePack)
    {
        ...
        for (int i = 0; i < files.Length; i++)
        {
            ...
            else
            {
                ...
                {
                    SetAbName(files[i].FullName, string.Empty, false);
                }
            }
        }
    }
    ...
    private static void SetSpritePackName(string source)
    {
        ...
        for (int i = 0; i < files.Length; i++)
        {
            if (!files[i].Name.EndsWith(".meta"))
            {
                ...
                SetAbName(files[i].FullName, files[i].Name, true);
            }
        }
    }

    private static void SetAbName(string source, string name, bool isPack)
    {
